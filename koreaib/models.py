...
class MarketBondIssueInfo(models.Model):
    ...
    bond_int_dfrm_mthd_cd = models.CharField(max_length=2, verbose_name='채권이자지급방법코드')
    splt_rdpt_rcnt = models.CharField(max_length=6, verbose_name='분할상환횟수')
    prca_dfmt_term_mcnt = models.CharField(max_length=6, verbose_name='원금거치기간개월수')
    ...
    pbff_pplc_ofrg_mthd_cd = models.CharField(max_length=2, verbose_name='공모사모모집방법코드')
    ...
    pnia_dfrm_agcy_istt_cd = models.CharField(max_length=4, verbose_name='원리금지급대행기관코드')
    ...
    int_dfrm_day_type_cd = models.CharField(max_length=2, verbose_name='이자지급일유형코드')
    ksd_int_calc_unit_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원이자계산단위코드')
    int_wunt_uder_prcs_dvsn_cd = models.CharField(max_length=1, verbose_name='이자원화단위미만처리구분코드')
    ...
    rght_stck_std_pdno = models.CharField(max_length=12, verbose_name='권리주식표준상품번호')
    ...
    kis_crdt_grad_text = models.CharField(max_length=500, verbose_name='한국신용평가신용등급내용')
    kbp_crdt_grad_text = models.CharField(max_length=500, verbose_name='한국채권평가신용등급내용')
    nice_crdt_grad_text = models.CharField(max_length=500, verbose_name='한국신용정보신용등급내용')
    fnp_crdt_grad_text = models.CharField(max_length=500, verbose_name='에프앤자산평가신용등급내용')
    dpsi_psbl_yn = models.CharField(max_length=1, verbose_name='예탁가능여부')
    pnia_int_calc_unpr = models.CharField(max_length=234, verbose_name='원리금이자계산단가')
    prcm_idx_bond_yn = models.CharField(max_length=1, verbose_name='물가지수채권여부')
    expd_exts_srdp_rcnt = models.CharField(max_length=10, verbose_name='만기연장분할상환횟수')
    expd_exts_srdp_rt = models.CharField(max_length=2212, verbose_name='만기연장분할상환율')
    ...
    krx_lstg_abol_dvsn_cd = models.CharField(max_length=1, verbose_name='한국거래소상장폐지구분코드')
    asst_rqdi_dvsn_cd = models.CharField(max_length=2, verbose_name='자산유동화구분코드')
    ...
    crfd_item_rstc_cclc_dt = models.CharField(max_length=8, verbose_name='크라우드펀딩종목제한해지일자')
    bond_nmpr_unit_pric = models.CharField(max_length=202, verbose_name='채권호가단위가격')
    ivst_heed_bond_dvsn_name = models.CharField(max_length=60, verbose_name='투자유의채권구분명')
    add_erng_rt = models.CharField(max_length=238, verbose_name='추가수익율')
    add_erng_rt_aply_dt = models.CharField(max_length=8, verbose_name='추가수익율적용일자')
    bond_tr_stop_dvsn_cd = models.CharField(max_length=1, verbose_name='채권거래정지구분코드')
    ivst_heed_bond_dvsn_cd = models.CharField(max_length=1, verbose_name='투자유의채권구분코드')
    ...
    cdtl_cptl_scty_type_cd = models.CharField(max_length=1, verbose_name='조건부자본증권유형코드')
    elec_scty_yn = models.CharField(max_length=1, verbose_name='전자증권여부')
    sq1_clop_ecis_opng_dt = models.CharField(max_length=8, verbose_name='1차콜옵션행사개시일자')
...
class MarketBondSearchInfo(models.Model):
    pdno = models.CharField(max_length=12, verbose_name='상품번호')
    prdt_type_cd = models.CharField(max_length=3, verbose_name='상품유형코드')
    ksd_bond_item_name = models.CharField(max_length=100, verbose_name='증권예탁결제원채권종목명')
    ksd_bond_item_eng_name = models.CharField(max_length=100, verbose_name='증권예탁결제원채권종목영문명')
    ksd_bond_lstg_type_cd = models.CharField(max_length=2, verbose_name='증권예탁결제원채권상장유형코드')
    ksd_ofrg_dvsn_cd = models.CharField(max_length=2, verbose_name='증권예탁결제원모집구분코드')
    ksd_bond_int_dfrm_dvsn_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원채권이자지급구분')
    issu_dt = models.CharField(max_length=8, verbose_name='발행일자')
    rdpt_dt = models.CharField(max_length=8, verbose_name='상환일자')
    rvnu_dt = models.CharField(max_length=8, verbose_name='매출일자')
    ...
    ksd_rcvg_bond_dsct_rt = models.CharField(max_length=2212, verbose_name='증권예탁결제원수신채권할인율')
    ksd_rcvg_bond_srfc_inrt = models.CharField(max_length=2012, verbose_name='증권예탁결제원수신채권표면이율')
    bond_expd_rdpt_rt = models.CharField(max_length=2212, verbose_name='채권만기상환율')
    ksd_prca_rdpt_mthd_cd = models.CharField(max_length=2, verbose_name='증권예탁결제원원금상환방법코드')
    ...
    uval_cut_dcpt_dgit = models.CharField(max_length=10, verbose_name='절상절사소수점자릿수')
    ksd_dydv_caltm_aply_dvsn_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원일할계산기간적용')
    dydv_calc_dcnt = models.CharField(max_length=5, verbose_name='일할계산일수')
    bond_expd_asrc_erng_rt = models.CharField(max_length=2212, verbose_name='채권만기보장수익율')
    padf_plac_hdof_name = models.CharField(max_length=60, verbose_name='원리금지급장소본점명')
    lstg_dt = models.CharField(max_length=8, verbose_name='상장일자')
    lstg_abol_dt = models.CharField(max_length=8, verbose_name='상장폐지일자')
    ksd_bond_issu_mthd_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원채권발행방법코드')
    laps_indf_yn = models.CharField(max_length=1, verbose_name='경과이자지급여부')
    ksd_lhdy_pnia_dfrm_mthd_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원공휴일원리금지급')
    frst_int_dfrm_dt = models.CharField(max_length=8, verbose_name='최초이자지급일자')
    ksd_prcm_lnkg_gvbd_yn = models.CharField(max_length=1, verbose_name='증권예탁결제원물가연동국고채여')
    ...
    dpsi_psbl_yn = models.CharField(max_length=1, verbose_name='예탁가능여부')
    atyp_rdpt_bond_erlm_yn = models.CharField(max_length=1, verbose_name='비정형상환채권등록여부')
    ...
    dpsi_psbl_excp_stat_cd = models.CharField(max_length=2, verbose_name='예탁가능예외상태코드')
    expd_exts_srdp_rcnt = models.CharField(max_length=10, verbose_name='만기연장분할상환횟수')
    expd_exts_srdp_rt = models.CharField(max_length=2212, verbose_name='만기연장분할상환율')
    expd_rdpt_rt = models.CharField(max_length=238, verbose_name='만기상환율')
    expd_asrc_erng_rt = models.CharField(max_length=238, verbose_name='만기보장수익율')
    bond_int_dfrm_mthd_cd = models.CharField(max_length=2, verbose_name='채권이자지급방법코드',
                                             choices=[('01', '할인채'), ('02', '복리채'), ('03', '이표채.확정금리'),
                                                      ('04', '이표채.금리연동'), ('05', '이표채.변동금리'),
                                                      ('06', '단리채'), ('07', '분할채'), ('09', '복5단2'),
                                                      ('19', '기타.고정금리'), ('29', '기타.변동금리')])
    int_dfrm_day_type_cd = models.CharField(max_length=2, verbose_name='이자지급일유형코드',
    ...
    aply_day_prcm_idx_lnkg_cefc = models.CharField(max_length=151, verbose_name='적용일물가지수연동계수')
    ksd_expd_dydv_calc_bass_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원만기일할계산기준')
    expd_dydv_calc_dcnt = models.CharField(max_length=7, verbose_name='만기일할계산일수')
    ksd_cbbw_dvsn_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원신종사채구분코드')
    crfd_item_yn = models.CharField(max_length=1, verbose_name='크라우드펀딩종목여부')
    pnia_bank_ofdy_dfrm_mthd_cd = models.CharField(max_length=1, verbose_name='원리금은행휴무일지급방법코드')
    ...
    ksd_opcb_yn = models.CharField(max_length=1, verbose_name='증권예탁결제원옵션부사채여부')
    ksd_sodn_yn = models.CharField(max_length=1, verbose_name='증권예탁결제원후순위채권여부')
    ksd_rqdi_scty_yn = models.CharField(max_length=1, verbose_name='증권예탁결제원유동화증권여부')
    elec_scty_yn = models.CharField(max_length=1, verbose_name='전자증권여부')
    rght_ecis_mbdy_dvsn_cd = models.CharField(max_length=1, verbose_name='권리행사주체구분코드')
    int_rkng_mthd_dvsn_cd = models.CharField(max_length=1, verbose_name='이자산정방법구분코드')
    ofrg_dvsn_cd = models.CharField(max_length=2, verbose_name='모집구분코드')
    ksd_tot_issu_amt = models.CharField(max_length=202, verbose_name='증권예탁결제원총발행금액')
    next_indf_chk_ecls_yn = models.CharField(max_length=1, verbose_name='다음이자지급체크제외여부')
    ksd_bond_intr_dvsn_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원채권금리구분코드')
    ksd_inrt_aply_dvsn_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원이율적용구분코드')
    krx_issu_istt_cd = models.CharField(max_length=5, verbose_name='KRX발행기관코드')
    ksd_indf_frqc_uder_calc_cd = models.CharField(max_length=1, verbose_name='증권예탁결제원이자지급주기미만')
    ksd_indf_frqc_uder_calc_dcnt = models.CharField(max_length=4, verbose_name='증권예탁결제원이자지급주기미만')
