...
from .views import MarketBondIssueInfoViewSet, MarketBondSearchInfoViewSet, \
                    MarketBondInquireAskingPriceViewSet, MarketBondAvgUnitViewSet, \
                    MarketBondInquireDailyItemChartPriceViewSet, MarketBondInquirePriceViewSet, \
                    MarketBondInquireCCNLViewSet, MarketBondInquireDailyPriceViewSet
...
router.register('market-bond-inquire-daily-item-chart-price', MarketBondInquireDailyItemChartPriceViewSet)
